...
def test_can_play_a_full_game():
    app.consoleio = MockConsoleIO(['1', '1', '', '1', '1', '', '1', '5', '2', '3', '7', '4', '6', '8', '9', 'n'])
    app.main()
...
def test_gracefully_handles_invalid_user_input():
    app.consoleio = MockConsoleIO(['1', '1', '', '1', '1', '', '-1', '1', '5', '2', '3', 'not a number', '7', '4', '3000', '6', '8', '9', 'n'])
    app.main()
...
def test_game_ends_if_a_player_wins():
    app.consoleio = MockConsoleIO(['1', '1', '', '1', '1', '', '1', '2', '3', '4', '5', '6', '7', 'n'])
    app.main()
